 ...
 * 
 * 
 * @author Numa ajout de la config pour charger le fichier de langue
 * 
 * @package   			CodeIgniter
 * @subpackage			Twiggy
 * @category  			Config
...
(
    'site_url', 'base_url', 'uri_string', 'anchor',
    'url_title', 'find_url', 'form_dropdown', 'sprintf', 'css',
    'img', 'js'
);
...
/*
|--------------------------------------------------------------------------
| Le fichier de langue pour le layout de base --->NUMA
|--------------------------------------------------------------------------
|
| le nom du fichier de base du Layout
|

 */
$config['twiggy']['language'] = 'layout/layout';