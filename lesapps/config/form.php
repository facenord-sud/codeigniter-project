 ...
 * This allows you to wrap all single errors within a styled element
 */
$config['error_string_open'] = '<div data-alert class="alert-box alert">';
$config['error_string_close'] = '<a href="#" class="close">&times;</a></div>';
...
$config['error_inline_open'] = ' <small class="error">';
$config['error_inline_close'] = '</small>';
...
$config['recaptcha_key_public']			= '6Lci5-ESAAAAAKD-ilLVUoPOs3gKSOHxBewrdy2x';	// Complete with your key
$config['recaptcha_key_private']		= '6Lci5-ESAAAAAJ4kqTFjekOBAeOwSi0HUvzaSXQo';	// Complete with your key
$config['recaptcha_theme']				= 'white';
$config['recaptcha_lang']				= 'fr';	// Valid language codes on http://recaptcha.net/apidocs/captcha/client.html
