...
$config['multilingual']['allowed_languages'] = array(
                                                    array('french', 'fr', 'localhost/collaide2/fr'),
                                                    array('english', 'en', 'localhost/collaide2/en'),
                                                    array('deutch', 'de', 'localhost/collaide2/de'),
                                                    array('developpement', 'dt', 'localhost/collaide2/dt')
